...
final class BomberAttack extends OperationProcessor
{
    ...
    public function processSuccess(): void
    {
        ...
        // to destroy. Bomber damage is measured in levels.
        $totalLevels = 0;
    ...
    public function processFailed(): void
    {
        ...
        foreach ($this->playerRegion->getWorldRegionStackableUnits() as $worldRegionStackableUnit) {
            if ($worldRegionStackableUnit->getGameUnit() === GameUnitEnum::BOMBER) {
                $worldRegionStackableUnit->setAmount(intval($worldRegionStackableUnit->getAmount() - $bombersLost));
